...
import {studentMenu} from "@/config/menu.ts";
...
export function StudentHeader() {
    ...
    return (
        <header
            ...
            <div className="md:px-8 flex h-14 items-center">
                <div className="mr-4 hidden md:flex">
                    <NavLink to="/student/schedule" className="mr-6 flex items-center space-x-2">
                        <Logo/>
                    </NavLink>
                    ...
                    <SheetContent side="left" className="pr-0 sm:max-w-xs">
                        ...
                        <ScrollArea className="my-4 h-[calc(100vh-8rem)] pb-8 pl-8">
                            <Accordion type="single" collapsible className="w-full"
                                       defaultValue={"item-" + studentMenu.findIndex(item => item.items !== undefined ? item.items.filter(subitem => subitem.to !== undefined).map(subitem => subitem.to).includes(location.pathname) : false)}>
                ...
                <a href="/student/schedule" className="mr-6 flex items-center space-x-2 md:hidden">
