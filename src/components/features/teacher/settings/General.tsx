                        ...
                        <div className="space-y-4 flex gap-8">
                            <div className="flex-shrink-0">
                                <Avatar className="w-48 h-48">
                                    <AvatarImage
                                        src={`https://avatar.iran.liara.run/username?username=${teacher.name}+${teacher.surname}`}/>
                            ...
                            <div className="space-y-2">
                                ...
                                <p>
                                    <strong>Škola:</strong> {teacher.school.name}, {teacher.school.county}, {teacher.school.city}
                                </p>
                                <p><strong>Razredi: </strong>
                                    {teacher.classesTeaching.map((schoolClass, index) => (
                                        <span key={index}>{schoolClass.year}.{schoolClass.division}
                                            {index < teacher.classesTeaching.length - 1 && ", "}</span>
                                    ))}
                                </p>
                            </div>
                        </div>
